...
class ResNet(BasicModule):
    def __init__(self, name, block, layers, input_channel, output_channel, pretrained=False, use_pool=False):
        ...
        if pretrained:
            ...
            pretrained_model = '/Users/Rudra/Downloads/deep_layout/train/pretrained_model/resnet34-333f7ec4.pth'
